...
namespace School_API.Controllers.Hr
{
    ...
    public class EmployeeExperienceController : BaseController
    {
        ...
        public EmployeeExperienceController(IEmployeeExperienceService service, ICurrentUserService currentUserService) : base(currentUserService)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateEmployeeExperienceDto model)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateEmployeeExperienceDto model)
        {
