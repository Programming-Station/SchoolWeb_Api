...
namespace School_API.Controllers.Hr
{
    ...
    {
        private readonly IEmployeeBankDetailService _service;

        public EmployeeBankDetailController(IEmployeeBankDetailService service, ICurrentUserService currentUserService) : base(currentUserService)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateEmployeeBankDetailDto model)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateEmployeeBankDetailDto model)
        {
