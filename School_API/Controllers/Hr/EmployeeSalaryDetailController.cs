...
namespace School_API.Controllers.Hr
{
    ...
    {
        private readonly IEmployeeSalaryDetailService _service;

        public EmployeeSalaryDetailController(IEmployeeSalaryDetailService service, ICurrentUserService currentUserService) : base(currentUserService)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateEmployeeSalaryDetailDto model)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateEmployeeSalaryDetailDto model)
        {
