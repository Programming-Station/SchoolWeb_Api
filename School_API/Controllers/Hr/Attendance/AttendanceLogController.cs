...
namespace School_API.Controllers.Hr.Attendance
{
    ...
    public class AttendanceLogController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateAttendanceLogDto model)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateAttendanceLogDto model)
        {
