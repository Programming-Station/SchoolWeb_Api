...
namespace School_API.Controllers.Academic
{
    ...
    public class HomeworkController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Submit([FromBody] HomeworkSubmitRequest req)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Grade([FromBody] HomeworkGradeRequest req)
        {
    ...
    public class AssignmentController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Submit([FromBody] AssignmentSubmitRequest req)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Grade([FromBody] AssignmentGradeRequest req)
        {
    ...
    public class OnlineClassController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Schedule([FromBody] OnlineClassDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] OnlineClassDto dto)
        {
    ...
    public class SyllabusController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddChapter([FromBody] SyllabusChapterDto dto)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetChapters([FromQuery] int subjectId, [FromQuery] int classId)
            => Ok(await _svc.GetChaptersAsync(subjectId, classId, _tenant.GetTenantId() ?? 0));

        [HttpPut]
        public async Task<IActionResult> UpdateProgress([FromQuery] int chapterId, [FromQuery] int completedPeriods)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> AddLessonPlan([FromBody] LessonPlanDto dto)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetLessonsByChapter([FromQuery] int chapterId)
            => Ok(await _svc.GetLessonPlansByChapterAsync(chapterId));

        [HttpGet]
        public async Task<IActionResult> GetLessonsByDate([FromQuery] int classId, [FromQuery] DateTime date)
            => Ok(await _svc.GetLessonPlansByDateAsync(classId, date, _tenant.GetTenantId() ?? 0));

        [HttpPut]
        public async Task<IActionResult> UpdateLessonStatus([FromQuery] int id, [FromQuery] string status, [FromQuery] string? notes = null)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> ToggleComplete([FromQuery] int topicId, [FromQuery] bool isCompleted)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> SaveTopic([FromBody] SaveTopicRequest req)
        {
