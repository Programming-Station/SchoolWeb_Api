...
namespace School_API.Controllers.Academic
{
    ...
    public class ExamScheduleController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ExamScheduleDto dto)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> SaveBulk([FromQuery] int examId, [FromBody] List<ExamScheduleDto> schedules)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ExamScheduleDto dto)
        {
    ...
    public class GradeConfigController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SaveGrades([FromBody] List<GradeConfigDto> grades)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetForPercent([FromQuery] decimal percent)
        {
    ...
    public class ReportCardController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Generate([FromQuery] int examId)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetStudentExam([FromQuery] int studentId, [FromQuery] int examId)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> AddRemarks([FromQuery] int id, [FromQuery] string remarks)
        {
    ...
    public class StudentPromotionController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> BulkPromote([FromBody] BulkPromotionRequest req)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetByClass([FromQuery] int fromClassId)
        ...
        [HttpGet]
        public async Task<IActionResult> GetEligible([FromQuery] int classId, [FromQuery] int examId)
