...
namespace School_API.Controllers.Fee
{
    ...
    public class FeeFineController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Apply([FromBody] FeeFineDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Waive([FromQuery] int id)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> MarkPaid([FromQuery] int id)
        {
    ...
    public class ScholarshipController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ScholarshipDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ScholarshipDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Revoke([FromQuery] int id)
        {
    ...
    public class FeeRefundController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Request([FromBody] FeeRefundDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Process([FromQuery] int id, [FromQuery] string? refundRef = null)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetTotalRefunded([FromQuery] DateTime from, [FromQuery] DateTime to)
        {
