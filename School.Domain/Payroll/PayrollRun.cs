...
namespace School.Domain.Payroll
{
    public class PayrollRun : AuditEntity<int>, ITenantEntity
    {
        ...
        [Column(TypeName=""decimal(10,2)"")] public decimal GrossSalary{get;set;}
        [Column(TypeName=""decimal(10,2)"")] public decimal TotalDeductions{get;set;}
        [Column(TypeName=""decimal(10,2)"")] public decimal NetSalary{get;set;}
