...
{
    public class ExamDto { public int Id { get; set; } public string Name { get; set; } = null!; public string? ExamType { get; set; } public DateTime StartDate { get; set; } public DateTime EndDate { get; set; } public string Status { get; set; } = "Scheduled"; public string? Description { get; set; } public bool IsResultPublished { get; set; } public DateTime? ResultPublishedDate { get; set; } public string? ResultPublishedBy { get; set; } }
