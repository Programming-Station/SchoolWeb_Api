...
namespace School.Infrastructure.Migrations
{
    ...
    [Migration("20260705155209_AddApplicationUserToEmployee")]
    partial class AddApplicationUserToEmployee
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("School.Domain.Hr.Attendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.AttendanceLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.HolidayMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.LeaveBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.LeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.LeaveSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.ShiftMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.Timesheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.TimesheetEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.WeekOff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Hr.Employee", b =>
                {
                    ...
                    b.HasOne("School.Domain.Hr.ShiftMaster", "Shift")
                        .WithMany()
            ...
            modelBuilder.Entity("School.Domain.Hr.LeaveBalance", b =>
                {
                    ...
                    b.HasOne("School.Domain.Hr.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("School.Domain.Hr.TimesheetEntry", b =>
                {
                    ...
                    b.HasOne("School.Domain.Hr.Timesheet", "Timesheet")
                        .WithMany("Entries")
