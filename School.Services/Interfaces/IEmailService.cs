...
namespace School.Services.Interfaces
{
    ...
    {
        Task<bool> SendTemplateAsync(string recipientEmail, string templateName, Dictionary<string, string>? placeholders);
        ...
        // Background Queueing
        void QueueTemplateEmail(string recipientEmail, string templateName, Dictionary<string, string>? placeholders);
